...
/**
 * Verifies that game state for a MarbleSolitaireModel is properly displayed.
 */

public class MarbleSolitaireModelImplTestGetGameState {
  ...
  private void init() {
    msm1 = new MarbleSolitaireModelImpl();
    msm2 = new MarbleSolitaireModelImpl(0,4);
    msm3 = new MarbleSolitaireModelImpl(3,5,4);
    msm4 = new MarbleSolitaireModelImpl(5);
  }
