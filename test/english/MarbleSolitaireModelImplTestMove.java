...
/**
 * Verifies that the move method works properly for the MarbleSolitaireModelImpl class.
 */

public class MarbleSolitaireModelImplTestMove {
  ...
  private void init() {
    ...
    this.msm2 = new MarbleSolitaireModelImpl(3,4,6);
  }
